  ...
  render() {
    return (
      <div className='todo-items uppercase'>
        <div onClick={() => this.props.handleTask(this.props.num, this.props.completed)} className='check-container'>
        ...
        <div onClick={() => this.props.removeTask(this.props.slideNum, this.props.completed, this.props.num)} className='delete-item'>
