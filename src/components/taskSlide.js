...
class TaskSlide extends Component {
  render() {
    return (
      <div onClick={this.props.closeTaskSlide} className='task-slide margin-bottom-10 title-s bold-title uppercase flex-property justify-content-between align-items-center'>
